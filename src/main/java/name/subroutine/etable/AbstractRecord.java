...
{
    /**
     * This must be passed from the parent table.  It is only included
     * here so that individual records can be handled separately.
     * Also, a fun thing to do is to change the field definitions
     * after the records are loaded.  Then all sorts of wacky stuff
     * can happen.
     */
    ...
    /**
     * Returns the number of fields in the record, according
     * to its field data
     */
    public int fieldCnt()
    {
    ...
    /**
     * Returns the number of elements in the record, according
     * to its value data
     */
    public int valueCnt()
    {
     ...
     *
     * Sometimes our values and field definitions do not match.  This
     * is usually a bad thing, but during the construction of a
     * record, we will have these intermediate states.
     */
     ...
     */
    public Record pushLst( ResultSet value )
	throws SQLException
    {
	int count;
