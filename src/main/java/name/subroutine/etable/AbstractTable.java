...
public abstract class AbstractTable implements Table
{
     ...
     * (alias for recordCnt.  not to be overridden)
     */
     ...
     *
     * The function will create a clone of the given field and adds it to the
    ...
    /**
     * Appends an etable with an array
     * Fields must be set first!!! (don't include the fields in the
     * array because it needs field information to append)
     */
